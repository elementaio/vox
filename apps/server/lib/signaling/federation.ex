defmodule Signaling.Federation do
  @moduledoc """
  ...
  defp post(url, json_payload) do
    ...
    pub = Signaling.RelayIdentity.pubkey_hex()
    ts = Integer.to_string(System.system_time(:second))
    sig = Signaling.RelayIdentity.sign("#{pub}|#{ts}|#{to}|#{mid}")
